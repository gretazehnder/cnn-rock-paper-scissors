...
Both Model A and Model B exhibited poor generalization performance, predicting the class \textit{paper} for all input images, regardless of the true label. This behavior indicates a strong bias toward a single class when exposed to out-of-distribution data.
